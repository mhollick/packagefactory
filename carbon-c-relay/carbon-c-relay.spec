...
Source1:	carbon-c-relay.init
Source2:        carbon-c-relay.sysconfig
...
%{__install} -m 755 carbon-c-relay.init %{buildroot}%{_sysconfdir}/init.d/%{name}
...
%{__install} -m 644 carbon-c-relay.sysconfig %{buildroot}%{_sysconfdir}/sysconfig/%{name}
...
%changelog
* Thu Jul 16 2015 Matthew Hollick <matthew@mayan-it.co.uk>
- fixed typo in previous changelog comment which broke build
- changed package name from cc_relay to carbon-c-relay because resons
